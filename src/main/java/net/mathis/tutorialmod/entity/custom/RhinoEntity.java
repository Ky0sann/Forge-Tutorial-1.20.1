package net.mathis.tutorialmod.entity.custom;

import net.mathis.tutorialmod.entity.ModEntities;
import net.mathis.tutorialmod.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setupAnimationStates() {
        ...
        if (this.isAttacking() && attackAnimationTimeout <= 0 ) {
            attackAnimationTimeout=80; // Length in ticks of the attack animation (here 4 seconds)
