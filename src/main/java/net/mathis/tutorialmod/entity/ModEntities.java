package net.mathis.tutorialmod.entity;

import net.mathis.tutorialmod.TutorialMod;
import net.mathis.tutorialmod.entity.custom.DiceProjectileEntity;
import net.mathis.tutorialmod.entity.custom.ModBoatEntity;
import net.mathis.tutorialmod.entity.custom.ModChestBoatEntity;
